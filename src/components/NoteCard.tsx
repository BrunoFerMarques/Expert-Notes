...
const NoteCard = ({note}: NoteCardProps) => {
  return (
    <Dialog.Root>
      ...
      <Dialog.DialogTrigger className="rounded-md bg-slate-800 text-left flex flex-col p-5 gap-3 overflow-hidden relative hover:ring-2 hover:ring-slate-600 outline-none focus-visible:ring-2 focus-visible:ring-lime-400">
